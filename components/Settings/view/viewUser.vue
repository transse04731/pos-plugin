	...
	<fragment>
		<g-grid-layout :layout="layout" style="height: calc(100% - 64px)">
			<div area="list">
				...
				<div class="row-flex align-items-center pa-2 pl-3" @click="dialogUserDetail = true">
					<g-avatar size="40">
			...
			<div area="edit">
				...
				<div class="edit__item">
					<pos-text-field label="Name" @focus="dialogUserDetail = true">
						<template v-slot:append>
		...
		<dialog-user-detail v-model="dialogUserDetail"/>
	</fragment>
</template>
