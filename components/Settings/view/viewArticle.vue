...
<script>
  export default {
    name: 'viewArticle',
    injectService: [
      'SettingsStore:(getListProducts, listProducts, productFilters, selectedProductIDs, totalProducts, getTotalProducts, productPagination, selectedProduct, updateProductFilters)',
    ],
    data() {
      return {
