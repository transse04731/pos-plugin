    ...
    data: function () {
      return {
        numpad: [
          ...
          { content: ['LOGIN'], classes: 'key-number ba-blue-9 ba-thin', action: this.keyboardLogin, style: 'grid-area: keyLogin; background-color: #2979FF; color: #ffffff; border: none; font-size: 16px;' },
        ],
