    ...
    data() {
      return {
        keyboardFull: [
          ...
          { content: ['7'], action: (value) => (value + '7'), style: 'grid-area: key7' },
          { content: ['8'], action: (value) => (value + '8'), style: 'grid-area: key8' },
          { content: ['9'], action: (value) => (value + '9'), style: 'grid-area: key9' },
          { content: ['4'], action: (value) => (value + '4'), style: 'grid-area: key4' },
          { content: ['5'], action: (value) => (value + '5'), style: 'grid-area: key5' },
          { content: ['6'], action: (value) => (value + '6'), style: 'grid-area: key6' },
          { content: ['1'], action: (value) => (value + '1'), style: 'grid-area: key1' },
          { content: ['2'], action: (value) => (value + '2'), style: 'grid-area: key2' },
          { content: ['3'], action: (value) => (value + '3'), style: 'grid-area: key3' },
          { content: ['0'], action: (value) => (value + '0'), style: 'grid-area: key0' },
